...
result = shell.exec("webpack --mode production --entry ./test/fixtures/bundle-entrypoint.js --output-path /tmp --output-filename webpack-bundle.js").code ||
...
result = shell.exec("browserify test/fixtures/bundle-entrypoint.js > /tmp/browserify-bundle.js").code ||
  shell.exec("npm run test").code || result;
